...
class _EmployeeJourneyScreenState extends State<EmployeeJourneyScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final journeyStepsByEmployee = {
      ...
      'jamie-lee': [
        ...
        JourneyStep(
          phase: 'Day 1',
          title: 'System Access Granted',
          subtitle: 'Email, Slack, and product tools provisioned',
          date: '2026-08-19',
          status: 'Completed',
          icon: Icons.vpn_key,
        ),
        JourneyStep(
          phase: 'Day 1',
          title: 'Team Introduction',
          subtitle: '1:1 with manager and product team kickoff',
          date: '2026-08-19',
          status: 'In Progress',
          icon: Icons.people,
        ),
        JourneyStep(
          ...
          subtitle: 'Review current roadmap and stakeholder map',
          date: '2026-08-22',
          status: 'Pending',
        ...
        JourneyStep(
          ...
          subtitle: 'Draft first product requirements doc',
          date: '2026-08-28',
          status: 'Pending',
          icon: Icons.assignment,
        ),
      ...
      'taylor-smith': [
        ...
        JourneyStep(
          phase: 'Pre-onboarding',
          title: 'Background Check',
          subtitle: 'Verification completed with third party',
          date: '2026-08-11',
          status: 'Completed',
          icon: Icons.verified_user,
        ),
        JourneyStep(
          phase: 'Day 1',
          title: 'System Access Granted',
          subtitle: 'Design tools and asset library provisioned',
          date: '2026-08-17',
          status: 'Completed',
          icon: Icons.vpn_key,
        ),
        JourneyStep(
          phase: 'Day 1',
          title: 'Team Introduction',
          subtitle: '1:1 with manager and design team kickoff',
          date: '2026-08-17',
          status: 'Completed',
          icon: Icons.people,
        ),
        JourneyStep(
          ...
          subtitle: 'Walkthrough of component library and guidelines',
          date: '2026-08-19',
          status: 'In Progress',
    ...
    final journeySteps =
        journeyStepsByEmployee[_selectedEmployee] ??
        journeyStepsByEmployee['alex-morgan']!;
